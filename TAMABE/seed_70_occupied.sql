...
-- 2. Creación de Tabla de Espacios
...
-- 3. Creación de Tabla de Reservas
...
-- 4. Creación de Tabla de Bitácoras
CREATE TABLE logs (
    id VARCHAR(50) PRIMARY KEY,
    spaceId INT,
    spaceLabel VARCHAR(10) NOT NULL,
...
-- 5. Inserción de los 110 espacios con 70 ocupados con nombres chilenos realistas y 40 libres
-- Sectores detallados:
-- Sector A (Cubículos 1 - 30): Regular, Directivo y Moto
-- Sector B (Cubículos 31 - 90): Regular y Moto
-- Sector C (Cubículos 91 - 110): Preferencial, Regular y Moto

-- SECUENCIA DE INSERCIÓN DIRECTA
